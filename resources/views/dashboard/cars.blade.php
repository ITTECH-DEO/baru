                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label>Another Image <small style="color: red">Recomended size height 366px width
                                                650px</small></label>
                                        <input type="file" class="form-control" name="img_car_lainnya">
                                        <input type="hidden" name="old_img_car_lainnya" value="{{ $car->img_car_lainnya }}">
                                    ...
                                    <div class="col-md-3">
                                        <label>Another Image <small style="color: red">Recomended size height 366px width
                                                650px</small></label>
                                        <input type="file" class="form-control" name="img_car_lainnya2">
                                        <input type="hidden" name="old_img_car_lainnya2" value="{{ $car->img_car_lainnya2 }}">
                                    ...
                                    <div class="col-md-3">
                                        <label>Another Image<small style="color: red">Recomended size height 366px width
                                                650px</small></label>
                                        <input type="file" class="form-control" name="img_car_lainnya3">
                                        <input type="hidden" name="old_img_car_lainnya3" value="{{ $car->img_car_lainnya3 }}">
                                    ...
                                    <div class="col-md-3">
                                        <label>Another Image <small style="color: red">Recomended size height 366px width
                                                650px</small></label>
                                        <input type="file" class="form-control" name="img_car_lainnya4">
                                        <input type="hidden" name="old_img_car_lainnya4" value="{{ $car->img_car_lainnya4 }}">
                                ...
                                <div class="row" style="margin-bottom: 20px">
                                    ...
                                    <div class="col-xs-3" >
                                        ...
                                        <img src="{{ $car->img_car2 }}" alt=""
                                            style="height: 150px;width: 100%" style="display:none ;" >
                                    </div>
                                    <div class="col-xs-3" >
                                        <img src="{{ $car->img_car }}" alt="" style="height: 150px;width: 100%" style="display:none ;" >
                                        {{-- {{ $car->img_car }} --}}
                                    </div>
                                </div>
                                <div class="row" style="margin-bottom: 20px">
