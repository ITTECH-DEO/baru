                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="pull-right col-md-6">
                            ...
                            <p align="right"><a href="#" class="btn btn-warning btn-sm" data-toggle="modal"
                                    data-target="#Booked">Booked</a></p>
                            @elseif($data->status_transaction == 'agree')
                            <p align="right"><a href="#" class="btn btn-danger btn-sm" data-toggle="modal"
                                    data-target="#Sold">Sold</a></p>
                            @else
